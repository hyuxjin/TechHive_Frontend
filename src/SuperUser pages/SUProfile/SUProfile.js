...
const SUProfile = () => {
  ...
  const handleUpdateClick = async () => {
    ...
    try {
      const response = await fetch(`https://techhivebackend-production-86d4.up.railway.app/superuser/updateSuperUserPassword?superuserId=${superuser.superuserId}`, {
        method: "PUT",
        headers: {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://techhivebackend-production-86d4.up.railway.app/superuser/profile/uploadProfilePicture", {
        method: "POST",
        body: formData,
      });
